...
The 1 kHz PWM signal illustrates the expected sinusoidal envelope while revealing the high-frequency switching content generated by the PWM process. The corresponding FFT confirms the presence of the desired fundamental component at 976.6 Hz together with the ambient 60 Hz interference and the harmonic content introduced by PWM modulation.
[!ToDo] Research 200-900Hz content: spill from uneven N_fft? See filtered signal and resume analysis.
...
<p align="center">
  <em>Figure 8. Measured 1 kHz PWM waveform before analog reconstruction filtering.</em><br>
  <em>Figure 9. MATLAB FFT of the measured PWM waveform showing the fundamental component and harmonic content.</em>
</p>

These measurements validate both the microcontroller firmware and the MATLAB analysis tools before evaluating the analog reconstruction filters.
